...
export const CAREER_PATHS = [
  {
    ...
    subtitle: "Impara",
    description: "Le basi di Linux e della riga di comando",
    outcome: "Sei pronto a lavorare su server Linux",
    icon: "🖥️",
  ...
  {
    id: "sysadmin",
    title: "SysAdmin Operativo",
    subtitle: "Lavora",
    description: "Storage, OS, networking e autenticazione enterprise",
    outcome: "Gestisci server in produzione",
    icon: "⚙️",
  ...
  },
  {
    ...
    subtitle: "Scala",
    description: "Virtualizzazione, sicurezza e incident response",
    outcome: "Gestisci incidenti reali su infrastrutture complesse",
    icon: "🔥",
  ...
  },
  {
    id: "ai",
    title: "AI + Automation",
    subtitle: "Differenziati",
    description: "Usa l'intelligenza artificiale per lavorare meglio",
    outcome: "Usi AI per automatizzare e risolvere problemi complessi",
    icon: "🤖",
  ...
  },
  {
    ...
    subtitle: "Gestisci",
    description: "Simulazioni di infrastrutture aziendali reali",
    outcome: "Gestisci infrastrutture aziendali multi-tenant",
    icon: "🏢",
