    ...
    <div className="min-h-screen bg-[#0a0a0b] text-white">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="mb-10">
          ...
          <p className="text-[10px] text-slate-700 uppercase tracking-widest mb-3">
            Last Updated: {LAST_UPDATED}
          </p>
          <h1 className="text-2xl font-bold text-white">{doc.headline}</h1>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onBack}
              className="text-xs px-4 py-2 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-300 hover:text-white rounded-lg transition-all"
            >
              ← Back to Dashboard
            </button>
          </div>
